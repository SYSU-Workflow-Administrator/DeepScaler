...
save_all_fetch_data(times_train, 1, root_dir='/ssj/ssj/AdapGLGoogle/new_data_raw_train1/', interval=60, services=services,metrics=metrics)#interval 间隔


### pod
# "adservice"
file = '/ssj/ssj/AdapGLGoogle/new_data_raw_train1/1_{}_{}.log'.format(services[0],metrics[0])
adservice_pod=np.genfromtxt(file, dtype=np.double)
adservice_pod = adservice_pod[:,np.newaxis]
# "cartservice"
file = '/ssj/ssj/AdapGLGoogle/new_data_raw_train1/1_{}_{}.log'.format(services[1],metrics[0])
cartservice_pod=np.genfromtxt(file, dtype=np.double)
cartservice_pod = cartservice_pod[:,np.newaxis]
# "checkoutservice"
file = '/ssj/ssj/AdapGLGoogle/new_data_raw_train1/1_{}_{}.log'.format(services[2],metrics[0])
checkoutservice_pod=np.genfromtxt(file, dtype=np.double)
checkoutservice_pod = checkoutservice_pod[:,np.newaxis]
# "currencyservice"
file = '/ssj/ssj/AdapGLGoogle/new_data_raw_train1/1_{}_{}.log'.format(services[3],metrics[0])
currencyservice_pod=np.genfromtxt(file, dtype=np.double)
currencyservice_pod = currencyservice_pod[:,np.newaxis]
# "emailservice"
file = '/ssj/ssj/AdapGLGoogle/new_data_raw_train1/1_{}_{}.log'.format(services[4],metrics[0])
emailservice_pod=np.genfromtxt(file, dtype=np.double)
emailservice_pod = emailservice_pod[:,np.newaxis]
# "frontend"
file = '/ssj/ssj/AdapGLGoogle/new_data_raw_train1/1_{}_{}.log'.format(services[5],metrics[0])
frontend_pod=np.genfromtxt(file, dtype=np.double)
frontend_pod = frontend_pod[:,np.newaxis]
# "paymentservice"
file = '/ssj/ssj/AdapGLGoogle/new_data_raw_train1/1_{}_{}.log'.format(services[6],metrics[0])
paymentservice_pod=np.genfromtxt(file, dtype=np.double)
paymentservice_pod = paymentservice_pod[:,np.newaxis]
# "productcatalogservice"
file = '/ssj/ssj/AdapGLGoogle/new_data_raw_train1/1_{}_{}.log'.format(services[7],metrics[0])
...
file = '/ssj/ssj/AdapGLGoogle/new_data_raw_train1/1_{}_{}.log'.format(services[8],metrics[0])
...
# "recommendationservice"
file = '/ssj/ssj/AdapGLGoogle/new_data_raw_train1/1_{}_{}.log'.format(services[8],metrics[1])
...
# "shippingservice"
file = '/ssj/ssj/AdapGLGoogle/new_data_raw_train1/1_{}_{}.log'.format(services[9],metrics[1])
...
# "recommendationservice"
file = '/ssj/ssj/AdapGLGoogle/new_data_raw_train1/1_{}_{}.log'.format(services[8],metrics[2])
...
# "shippingservice"
file = '/ssj/ssj/AdapGLGoogle/new_data_raw_train1/1_{}_{}.log'.format(services[9],metrics[2])
...
# "recommendationservice"
file = '/ssj/ssj/AdapGLGoogle/new_data_raw_train1/1_{}_{}.log'.format(services[8],metrics[3])
...
# "shippingservice"
file = '/ssj/ssj/AdapGLGoogle/new_data_raw_train1/1_{}_{}.log'.format(services[9],metrics[3])
...
xx=xx.numpy()
print(xx.shape)
np.savez("/ssj/ssj/AdapGLGoogle/new_data_raw_train1/sumhab1", xx)###生成原始的序列数据
### for test
all_data = read_and_generate_dataset(graph_signal_matrix_filename='/ssj/ssj/AdapGLGoogle/new_data_raw_train1/sumhab1.npz', num_of_hours=1, num_for_predict=1, points_per_hour=80, save=True)